...
export const LoadingState = ({ title, description }: Props) => {
  return (
    <div className="py-4 px-8 flex flex-1 items-center justify-center min-h-[400px]">
      <div className="relative flex flex-col items-center justify-center gap-y-4 bg-gradient-to-br from-white to-gray-50 dark:from-gray-900 dark:to-gray-800 rounded-xl p-8 shadow-lg border border-gray-200 dark:border-gray-700 max-w-sm w-full">
        ...
        <div className="relative z-10">
          ...
          <Loader2 className="relative size-12 animate-spin text-blue-600 dark:text-blue-400" strokeWidth={2.5} />
        </div>
